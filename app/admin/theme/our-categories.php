...
<html lang="en" dir="ltr">
  ...
  <title>Admin - Our Categories list</title>
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">Our Categories List</span>
      ...
      <tbody>
        ...
        <?php
          ...
          foreach ($result as $key) {
            ...
            $icon = $result[$i]->category_icon;
            $name = $result[$i]->category_name;
            $desc = $result[$i]->category_desc;
            ...
            $status = $result[$i]->is_active;

            echo "<tr>";
            echo "<td class='py-0'>
            <img src='./uploads/categories/$icon' alt='Supplier Image'>
          </td>";
          ...
          <div class='dropdown'>
            ...
            <div class='dropdown-menu dropdown-menu-right' aria-labelledby='dropdownMenuLink'>
              <a href='update-category.php' class='dropdown-item' href='#'>Update this category</a>
              <a href='categories-discount.php'  class='dropdown-item' href='#'>Discount management</a>
              <a href='coupons.php'  class='dropdown-item' href='#'>Coupons</a>
              <a href='category-products.php'  class='dropdown-item' href='#'>Category products</a>
            </div>
          </div>
        </td>
        </tr>";
