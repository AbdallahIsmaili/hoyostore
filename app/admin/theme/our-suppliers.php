...
<html lang="en" dir="ltr">
  ...
  <title>Admin - Our Suppliers list</title>
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">Our Suppliers List</span>
      ...
      <tbody>
        ...
        <?php
          ...
          foreach ($result as $key) {
            ...
            $logo = $result[$i]->supplier_logo;
            $name = $result[$i]->company_name;
            $email = $result[$i]->supplier_email;
            $website = $result[$i]->supplier_website;
            $country = $result[$i]->supplier_country;

            $joinDate = $result[$i]->join_at;
            $dt = new DateTime($joinDate);

            $dt =  $dt->format('Y-m-d');

            $status = $result[$i]->supplier_status;

            echo "<tr>";
            echo "<td class='py-0'>
            <img src='./uploads/suppliers/$logo' alt='Supplier Image'>
          </td>";
          ...
          if($status == 1){
            echo "<td><span class='badge badge-square badge-success'>Dynamic</span></td>";
          }else{
            echo "<td><span class='badge badge-square badge-danger'>Inoperative</span></td>";
          }
          ...
          <div class='dropdown'>
            ...
            <div class='dropdown-menu dropdown-menu-right' aria-labelledby='dropdownMenuLink'>
              <a href='update-supplier.php' class='dropdown-item' href='#'>Update this supplier</a>
              <a href='supplier-discount.php'  class='dropdown-item' href='#'>Discount management</a>
              <a href='coupons.php'  class='dropdown-item' href='#'>Coupons</a>
              <a href='supplier-products.php'  class='dropdown-item' href='#'>Supplier products</a>
            </div>
          </div>
        </td>
        </tr>";
