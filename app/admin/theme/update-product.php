...
if(isset($_POST['submit-product-search-form'])){
    $searchedProductName = trim($_POST['searched-product-name']);
    $productMaxPrice = trim($_POST['searched-product-max-price']);
    $productMinPrice = trim($_POST['searched-product-min-price']);
    $category = trim($_POST['category-id']);
    $supplier = trim($_POST['supplier-id']);

    if(empty($searchedProductName)){
        $searchedProductName = "";
    }

    if(empty($productMaxPrice) or $productMaxPrice < 0 ){
        $productMaxPrice = 0;
    }

    if(empty($productMinPrice) or $productMinPrice < 0){
        $productMinPrice = 0;
    }
      ...
      <div class="page-wrapper">
          ...
          <header class="main-header" id="header">
            <nav class="navbar navbar-expand-lg navbar-light" id="navbar">
              ...
              <span class="page-title">Update Product</span>
        ...
        <div class="card card-default">
            ...
            <div class="form-group">
                <label for="exampleFormControlInput4">Search By Name</label>
                <input type="search" name="searched-product-name" class="form-control rounded-0" id="exampleFormControlInput4" placeholder="Enter Name">
                <span class="mt-2 d-block">Search on a product by name, then choose the one you want to update.</span>
            </div>
            ...
            <div class="form-group">
                <label for="exampleFormControlInput4">Minimum price</label>
                <input type="number" min="0" name="searched-product-min-price" class="form-control rounded-0" id="exampleFormControlInput4" placeholder="Enter Name">
            </div>

            <div class="form-group">
                <label for="exampleFormControlInput4">Maximum price</label>
                <input type="number" min="0" name="searched-product-max-price" class="form-control rounded-0" id="exampleFormControlInput4" placeholder="Enter Name">
            </div>
            
            <div class="form-footer">
                <button type="submit" name ="submit-product-search-form" class="btn btn-secondary btn-pill">Submit</button>
